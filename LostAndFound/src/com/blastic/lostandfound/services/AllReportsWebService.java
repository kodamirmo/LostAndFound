...
public class AllReportsWebService {

	private HttpClient cliente;

	public AllReportsWebService() {
		HttpParams params = new BasicHttpParams();
		HttpConnectionParams.setConnectionTimeout(params, 5000);
		cliente = new DefaultHttpClient(params);
	}

	private JSONObject consultarWebService() {
		String url = "http://pawhub.me/api/lnf/Reports";
	...
	public ArrayList<Report> getReports() {
		...
		JSONObject json = consultarWebService();
