...
public class ReportsByTypeWebService {

	private HttpClient cliente;

	public ReportsByTypeWebService() {
		HttpParams params = new BasicHttpParams();
		HttpConnectionParams.setConnectionTimeout(params, 5000);
		cliente = new DefaultHttpClient(params);
	}

	private JSONObject consultarWebService(String reportType) {
		String url = "http://pawhub.me/api/lnf/Reports?type="+reportType;
	...
	public ArrayList<Report> getReports(String reportType) {

		ArrayList<Report> listReport = new ArrayList<Report>();
		JSONObject json = consultarWebService(reportType);
	...
	public Report crearReporte(String reportType) {
		JSONObject json = consultarWebService(reportType);
		return parser(json);
	}
