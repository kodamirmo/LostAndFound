...
public class ReportsByTypeAndPageWebService {

	private HttpClient cliente;

	public ReportsByTypeAndPageWebService() {
		HttpParams params = new BasicHttpParams();
		HttpConnectionParams.setConnectionTimeout(params, 5000);
		cliente = new DefaultHttpClient(params);
	}

	private JSONObject consultarWebService(String reportType, int page) {
		String url = "http://pawhub.me/api/lnf/Reports?type="+reportType+"&pageSize="+page;
	...
	public ArrayList<Report> getReports(String reportType, int page) {

		ArrayList<Report> listReport = new ArrayList<Report>();
		JSONObject json = consultarWebService(reportType, page);
	...
	public Report crearReporte(String reportType, int page) {
		JSONObject json = consultarWebService(reportType, page);
		return parser(json);
	}
